...
func TestRemoteSimple(t *testing.T) {
	...
	go remote.ListenAndServe("0.0.0.0:7651", pool)
	client, err := remote.NewClient("0.0.0.0:7651")
	require.NoErrorf(t, err, "NewClient error")
	db, err := remote.OpenRemoteDB(client, "leveldb", path, true)
...
func TestRemoteSnapshot(t *testing.T) {
	...
	t.Logf("path: %s", path)
	require.NoErrorf(t, err, "Open error")
	go remote.ListenAndServe("0.0.0.0:7652", pool)
	client, err := remote.NewClient("0.0.0.0:7652")
	require.NoErrorf(t, err, "NewClient error")
	db, err := remote.OpenRemoteDB(client, "leveldb", path, true)
	require.NoErrorf(t, err, "OpenRemoteDB error")
	_, err = db.Get([]byte("key"))
...
func TestRemoteBatch(t *testing.T) {
	...
	require.NoErrorf(t, err, "Open error")
	go remote.ListenAndServe("0.0.0.0:7653", pool)
	client, err := remote.NewClient("0.0.0.0:7653")
	require.NoErrorf(t, err, "NewClient error")
	db, err := remote.OpenRemoteDB(client, "leveldb", path, true)
	require.NoErrorf(t, err, "OpenRemoteDB error")
	batch := db.NewBatch()
...
func TestRemoteIter(t *testing.T) {
	...
	require.NoErrorf(t, err, "Open error")
	go remote.ListenAndServe("0.0.0.0:7654", pool)
	client, err := remote.NewClient("0.0.0.0:7654")
	require.NoErrorf(t, err, "NewClient error")
	db, err := remote.OpenRemoteDB(client, "leveldb", path, true)
	require.NoErrorf(t, err, "OpenRemoteDB error")
	batch := db.NewBatch()
